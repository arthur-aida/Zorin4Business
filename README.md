...
Veja os slide 17 a 22  do tutorial 3-InstalarSOnoKVMLinux.pdf para baixar os scripts e, no terminal, execute o comando chmod +x *.sh para torná-los executáveis.
Ainda no terminal digite: <sudo su> para elevar-se ao modo root. Digite no terminal do root:  bash run.sh <número do perfil escolhido>
