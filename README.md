...
Ainda no terminal digite no prompt "sudo su" para elevar-se ao modo root. Digite no terminal do root digite: "bash run.sh" e leias as instruções de como proceder a customização. No teminal digite somente comandos entre " ".
