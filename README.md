...
## 3. Procedimentos realizados pelo Administrador
    A) Preparação de um desktop/notebook (mínimo um I3, 6G RAM, SSD 240G) pela execução do script preparatório prepsrvnfsacng.sh que instala o KVM-Linux e o  nfs-server (Ver o tutorial 1-PrepararNotebookComNFS-Server.pdf) e prepara pastas para os caches;
